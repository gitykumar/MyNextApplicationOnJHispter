...
import io.github.jhipster.application.MyNextApplicationOnJHispterApp;
 ...
 */
@SpringBootTest(classes = {MyNextApplicationOnJHispterApp.class, TestSecurityConfiguration.class})
@Transactional
